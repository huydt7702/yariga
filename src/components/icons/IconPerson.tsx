const IconPerson = (props: JSX.IntrinsicElements['svg']) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        d="M14.4996 10.9691C16.4729 10.7232 17.9999 9.03992 17.9999 7.00001C17.9999 4.96009 16.4729 3.27682 14.4996 3.03091C15.4334 4.08866 15.9999 5.47817 15.9999 7.00001C15.9999 8.52185 15.4334 9.91136 14.4996 10.9691Z"
        fill="currentColor"
      />
      <path
        d="M20 20C20 20.5523 20.4477 21 21 21C21.5523 21 22 20.5523 22 20V18C22 15.3399 19.9227 13.165 17.3018 13.009C18.3539 13.9407 19.1587 15.1453 19.6055 16.512C19.8565 16.9505 20 17.4585 20 18V20Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
